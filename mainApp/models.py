...
class Registration(models.Model):
    "Возможность регистрации на события "
    subject = models.ForeignKey('Event')
    site_user = models.ForeignKey(SiteUser, blank=True, default=None, null=True)
    name = models.CharField(verbose_name='Имя для регистации через имейл', max_length=100)
    email = models.EmailField(verbose_name='Адрес для регистации через имейл')
